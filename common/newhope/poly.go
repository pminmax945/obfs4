...
import (
	...
	"git.torproject.org/pluggable-transports/obfs4.git/common/chacha20"
...
func (p *poly) getNoise(seed *[seedBytes]byte, nonce byte) {
	...
	// XXX: This is inconsistent with how error_correction.c
	// specifies the nonce.  Harmless, but odd.
	n[0] = nonce
